...
export const products = [
  ...
  {
    id: "7613-9641-98323-basu-05",
    image: "images/products/backpack.jpg",
    name: "Black stylishh backpack",
    rating: {
      stars: 4.0,
      count: 3133,
    },
    priceCents: 1330,
    keywords: ["Backpack", "Laptop Bag", "Bag", "Waterproof backpack"],
  },
  {
    id: "712611-9641-98323-basu-05",
    ...
    priceCents: 900,
    keywords: ["Umbrella", "Sturdy umbrella", "Colorful umbrella", "rain"],
  },
].map((productDetails) => {
  if (productDetails.type === "clothing") {
    return new Clothing(productDetails);
